...
export default function SubSiderbarMenu() {
  ...
  return (
    <Menu className="xt-menu flex-1" mode="inline"
      inlineCollapsed={subMenuCollapse} selectedKeys={[defaultActive]} openKeys={openKeys}
      onOpenChange={e => handleChange(e)} items={menuItems} onClick={clickSubMenu} />
  )
}
